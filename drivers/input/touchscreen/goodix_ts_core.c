		...
		struct goodix_pen_data *pen_data)
{
	...
	if (pen_data->coords.status == TS_TOUCH) {
		...
		input_report_abs(dev, ABS_X, pen_data->coords.y);
		input_report_abs(dev, ABS_Y, pen_data->coords.x);
		...
		input_report_abs(dev, ABS_TILT_X, pen_data->coords.tilt_y);
		input_report_abs(dev, ABS_TILT_Y, pen_data->coords.tilt_x);
